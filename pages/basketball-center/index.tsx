        ...
        <main className={styles.main}>
          ...
          <div className={styles.header}>
            ...
            <p>
              ...
              about players and teams. All the NBA games stats are updated real
          ...
          <div className={styles.project_info}>
            ...
            <p>
              ...
              from multiple NBA apis and scraping the web to be able to show
              some unique and complicated tables to the user.
            </p>
            <ul>
              <li>NodeJS</li>
              <li>Express</li>
