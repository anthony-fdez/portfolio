          ...
          <main className={styles.main}>
            ...
            <div className={styles.header}>
              ...
              <p>
                ...
                post and downvote and upvote any post or comment.
              </p>
            </div>
            ...
            <div className={styles.project_info}>
              ...
              <ul>
                <li>
                  Implemented key infrastructure on the backend and created
                  routes and models to handle user authentication, CRUD actions
                  to the databases such as following users, and upvoting posts.
                </li>
                <li>
                ...
                <li>
                  Created a fully functional comment section with nested
                  comments, similar to reddit.com.
                </li>
              </ul>
